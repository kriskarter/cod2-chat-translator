...
Переводчик хранит такие пути как **профили**. В списке **«Сервер / профиль»** можно быстро переключиться на нужный лог и при желании дать профилю понятное имя, например `OBRONA`.
