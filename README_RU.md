...
Размер текста, фон, время показа и количество сообщений на экране настраиваются прямо в приложении. Чистый скрин главного окна показан ниже в разделе «Первый запуск».
...
<p align="center">
  <img src="docs/images/showcase_main_window.webp" width="100%" alt="Главное окно CoD2 Chat Translator">
</p>
