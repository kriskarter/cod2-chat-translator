...
При первом запуске программа попробует найти логи сама. В обычной ситуации путь к файлу выбирать не нужно.

Если автоматика не нашла нужный лог, открой **«Настройки сервера…»** и выбери `console_mp.log` вручную.
...
Пути к логам всё равно сохраняются как внутренние **профили**. Они нужны для ручного режима и находятся в окне **«Настройки сервера…»**. Там можно выбрать конкретный лог, добавить его вручную, переименовать профиль или повторно просканировать папки CoD2.
